...
- [x] **Monorepo com separação de serviços** ✅ **IMPLEMENTADO**
  ...
  - Documentado no README.md principal
- [x] **API Gateway (KrakenD)** ✅ **IMPLEMENTADO**
  ...
  - Porta 8080 ✅
  - Documentado em gateway/krakend/krakend.json e README.md principal
...
- [x] **Código tolerante a falhas** ✅ **IMPLEMENTADO**
  ...
  - Documentado no README.md principal e código implementado ✅
