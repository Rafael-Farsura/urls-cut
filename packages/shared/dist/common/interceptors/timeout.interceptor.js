...
let TimeoutInterceptor = class TimeoutInterceptor {
    constructor(configService) {
        ...
        this.timeout = this.configService.get('app.requestTimeout') || 30000;
    }
    intercept(context, next) {
        return next.handle().pipe((0, operators_1.timeout)(this.timeout), (0, operators_1.catchError)(err => {
            if (err instanceof rxjs_1.TimeoutError) {
                return (0, rxjs_1.throwError)(() => new common_1.RequestTimeoutException(`A requisição excedeu o tempo limite de ${this.timeout}ms`));
            }
